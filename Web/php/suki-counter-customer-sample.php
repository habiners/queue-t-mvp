    ...
    <section class="content">
        <div class="container">
            ...
            <div class="contaier mt-3 ml-5">
                <div class="row ml-5">
                    <a class="sukiBackBtn mr-5" href="suki-counter.php">
                        <i class="fas fa-arrow-left"></i>
                    </a> 
                    <h4 class="uppercase">Juan dela Cruz</h4>
                </div>
            </div>
            <div class="row ml-5 mr-5 mt-2">
                <table class="table">
                  ...
                  <tbody id="tableSuki">
                    <tr class="text-center sukiTableTr">
                      <th scope="row">July 10, 2020</th>
                      <td>Tooth Extraction</td>
                      <td>Took out deacy teeth. Needs dentures</td>
                    </tr>
                    <tr class="text-center sukiTableTr">
                        <th scope="row">March 24, 2020</th>
                        <td>Cleaning</td>
                        <td>needs tooth extraction</td>
                      </tr>
                  </tbody>
                </table>
        </div>
