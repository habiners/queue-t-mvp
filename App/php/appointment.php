            ...
            <div class="list-group">
                ...
                <a href="appointment-normal.php" class="list-group-item list-group-item-action flex-column align-items-start">
                  <div class="d-flex w-100 justify-content-between">
                    ...
                    <small><span class="badge">3:00 PM</span></small>
                  </div>
                  <div class="d-flex w-100 justify-content-between">
                    <small>2 Services</small>
                  </div>
                </a>
                <h7 class="mt-3">08/03/2020</h7>
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                  <div class="d-flex w-100 justify-content-between">
                    <h5 class="mb-1">Salon Pass</h5>
                    <small><span class="badge">09:00 AM</span></small>
                  </div>
                  <div class="d-flex w-100 justify-content-between">
                    <small>Hair Bender</small>
                  </div>
                </a>
            </div>
