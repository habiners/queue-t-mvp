<?php
  ...
  WHERE BUSINESS.businessCategoryID = BUSINESS_CATEGORY.businessCategoryID AND businessID = $businessID;");
                            ...
                            <div class="card-body col-auto mr-5 mb-0">
                                ...
                                <?php
                                  //BUSINESS HOURS DAPIT============================================================================
                                    ...
                                    $statement = $pdo->query("SELECT * FROM BUSINESS INNER JOIN BUSINESS_HOURS WHERE BUSINESS_HOURS.businessHoursID = BUSINESS.businessHoursID AND BUSINESS.businessID = $businessID;");
                                        ...
                                        <div class="modal-body">
                                            <div class="container ml-2 mr-2">
                                                    ...
                                                    <div class="input-group mb-3">
                                                      ...
                                                      <input type="number" class="form-control" placeholder="price starts">
                                                      <input type="number" class="form-control" placeholder="price ends">
                                                    </div>
