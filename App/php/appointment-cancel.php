...
<html>
    ...
    <body>
        <!-- Home Content -->
        <div class="container-cancel content-bottom-spacing">
            <div class="row header-content header-content-cancel">
                <div class="col-sm-x3">
                ...
                <div class="col">
                    <h4 class="notif-type">Cancelled</h4>
                </div>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Are you sure to Delete this Cancelled Appointment?</p>
                                </div>
            ...
            <div class="container-fluid mt-2">
                <div class="row">
                    <div class="col mt-2">
                        <h6 class="store-name">Sheenpai Tooth Cemetery</h6>
                    </div>
